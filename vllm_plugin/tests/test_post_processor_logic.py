...
# Mocking the classes if import fails or to isolate logic
@dataclass
class AudioChunk:
    original_file: str = "test.wav"
    chunk_path: str = "/tmp/test.wav"
...
try:
    from test_api_and_align import PostProcessor, ASRResult, AudioChunk
except ImportError:
    import sys
    import os
